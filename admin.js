...
function renderStockTable() {
    ...
    if (lignesAjoutees === 0) {
        html += `<tr><td colspan="13" style="text-align: center; padding: 15px; color: #777;">Aucun produit ou SKU trouvé pour cette recherche.</td></tr>`;
    }
...
// --- GESTION DE LA MARGE COMMERCIALE (SAUVEGARDE) ---
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (boutonEnregistrer) {
        boutonEnregistrer.addEventListener('click', () => {
            ...
            if (nouvelleMarge !== '' && !isNaN(nouvelleMarge)) {
                ...
                alert('Marge commerciale mise à jour avec succès !');
            } else {
...
// ==========================================
// STATISTIQUES DE VENTE ET GRAPHIQUES
// ==========================================
